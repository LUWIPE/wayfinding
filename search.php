...
<div class="container">
    <div class="row justify-content-around mt-3">
        ...
        <div class="col-8 justify-content-center m-0 p-0">
            ...
            <div class="row justify-content-between mt-3 p-0" id="placesSearch">

                <?php

                $search = $_POST['search'];

                $sql = "SELECT * FROM places INNER JOIN category ON cateId = placeCategory WHERE placeName LIKE CONCAT('%', :search, '%')";
                $bind = [":search" => $search];
                ...
                ?>
                    <?php
                        ...
                        echo '<h2 class="text-end">Vi kunne ikke finde noget der matcher din søgning</h2>';
                    }
                    ?>
            </div>
        </div>
